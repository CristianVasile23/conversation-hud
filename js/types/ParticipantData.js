 ...
 * @property {string} displayName The name used
 *
 ...
 *
 * @property {string} linkedActor The ID of an actor associated to the participant
 * @property {string} linkedJournal The ID of a journal associated to the participant
 */
